                        ...
                        <div class="x_panel">
                          <div class="x_content" >
                            <table>
                              ...
                              <tr >
                                  <td>&nbsp;&nbsp;</td>
                                  <td align="center"><b><u>Struk Parkir</u></b>&nbsp;&nbsp;</td>
                                  <td>&nbsp;&nbsp;</td>
                            </table>
                            <hr>
                            ...
                            <table>
                              ...
                              <tr>
                                ...
                                <td><b>:&nbsp;&nbsp;</b></td>
                                <td><?php echo $pd->tanggal_keluar; ?></td>
                              </tr>
                              <tr>
                                <td><b>Jam keluar&nbsp;&nbsp;</b></td>
                                <td><b>:&nbsp;&nbsp;</b></td>
                                <td><?php echo $pd->jam_keluar; ?></td>
                              </tr>
                              
                            </table>
                            <br/><br/>
                              <h4 align="left">Biaya Parkir :</h4>
                              <h1 align="left"><b>Rp&nbsp;<?php echo $pd->biaya; ?></b></h1>
                            <?php } ?>
